...
const NavBar = () => {
        return (
                <div id='Navbar' className='w-[100%] h-[100%] bg-[#00173D] rounded-[4vmin] flex flex-col justify-start'>
                        ...
                        <div id="userdetails" className='h-[100%]'>
                                <div id="detailsContainer" className=''>
                        ...
                        <div id="NavButtonsContainer">
                                <div id='button'>
                                        {/* Home */}
                                        <Link  className='flex flex-row justify-between  w-[100%]' to='/'>
                                ...
                                <div id="button">
                                        {/* Courses */}
                                        <Link className='w-[100%] flex flex-row justify-between' to='/courses'>
                                ...
                                <div id="button">
                                        {/* Assignments */}
                                      <Link className='w-[100%] flex flex-row justify-between' to='/assignments'> 
                                      ...
                                      <p>Assignments </p></Link> 
                                </div>
                                <div id="button">
                                        {/* timeTable */}
                                      <Link className='w-[100%] flex flex-row justify-between' to='/timetable'> 
                                ...
                                <div id="button">
                                      <Link className='w-[100%] flex flex-row justify-between' to='/forum'>
                                ...
                                <div id='button'>
                                        {/* Setting */}
                                       <Link className='w-[100%] flex flex-row justify-between' to='/setting'>
